...
namespace NOpenInterface.Implementation.AspDotNet.Time
{
	using System;
	using NOpenInterface.Time;

	public abstract class DotNetClock : IClock<DateTime>
	{
		public abstract DateTime ApplicationNow { get; }
