...
namespace NOpenInterface.Patterns.Creational
{
	using System.Collections.Generic;

	/// <summary>
	/// 	Defines the interface for implementations of the Builder pattern.
	/// </summary>
	public interface IBuilder<TReturn, TBuildStep>
		where TBuildStep : IBuildStep<TReturn>
	{
		TReturn Build(IEnumerable<TBuildStep> args);
	}
}